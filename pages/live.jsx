...
export default function Blog({ posts }) {
  return (
    <Main className='container'>
      ...
      <h1 className="mt-24 text-3xl lg:text-4xl font-headline tracking-tight font-bold text-gray-900 leading-snug flex justify-center p-3">YiuAcademy Applications</h1>
      ...
      <div className='flex flex-col items-center flex-grow'>
        <div className='flex justify-end'>
          ...
          Tailor Made Learning<br />
            
          </h1>
        </div>

        <p className='text-gray-600 p-5 text-lg'>Learn different skills from teachers who can tailor make the course for you</p>
    ...
    <article className=' relative   sm:max-w-xl sm:mx-auto   flex rounded-xl flex-col overflow-hidden w-96  '>
      ...
      <div className='flex flex-col items-center flex-grow'>
        <div className='flex justify-end'>
          ...
          100% verified teachers<br />
            
          </h1>
        </div>

        <p className='text-gray-600 p-5 text-lg'>Learn from trust worthy teachers</p>
    ...
    <article className=' relative   sm:max-w-xl sm:mx-auto  flex rounded-xl flex-col  overflow-hidden w-96 '>
      ...
      <div className='flex flex-col items-center flex-grow'>
        ...
        <p className='text-gray-600 p-5 text-lg'>Learn at your own pace from your comfortable place</p>
